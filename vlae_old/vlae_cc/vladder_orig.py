...
class VLadder(Network):
    def __init__(self, dataset, name=None, reg='kl', batch_size=100, restart=False):
        ...
        if self.num_layers >= 4 and self.ladder3_dim > 0:
            ...
            tlatent3_state = layers.generative3(None, self.iladder3_sample, self.class_label_placeholder, self.n_classes, is_training=self.is_training)
            glatent3_state = layers.generative3(None, self.ladder3_placeholder, self.class_label_placeholder, self.n_classes, reuse=True, is_training=False)
        else:
        ...
        if self.num_layers >= 3 and self.ladder2_dim > 0:
            ...
            tlatent2_state = layers.generative2(tlatent3_state, self.iladder2_sample, self.class_label_placeholder, self.n_classes, is_training=self.is_training)
            glatent2_state = layers.generative2(glatent3_state, self.ladder2_placeholder, self.class_label_placeholder, self.n_classes, reuse=True, is_training=False)
        elif tlatent3_state is not None:
            tlatent2_state = layers.generative2(tlatent3_state, None, self.class_label_placeholder, self.n_classes, is_training=self.is_training)
            glatent2_state = layers.generative2(glatent3_state, None, self.class_label_placeholder, self.n_classes, reuse=True, is_training=False)
        else:
        ...
        if self.num_layers >= 2 and self.ladder1_dim > 0:
            ...
            tlatent1_state = layers.generative1(tlatent2_state, self.iladder1_sample, self.class_label_placeholder, self.n_classes, is_training=self.is_training)
            glatent1_state = layers.generative1(glatent2_state, self.ladder1_placeholder, self.class_label_placeholder, self.n_classes, reuse=True, is_training=False)
        elif tlatent2_state is not None:
            tlatent1_state = layers.generative1(tlatent2_state, None, self.class_label_placeholder, self.n_classes, is_training=self.is_training)
            glatent1_state = layers.generative1(glatent2_state, None, self.class_label_placeholder, self.n_classes, reuse=True, is_training=False)
        else:
        ...
        if self.ladder0_dim > 0:
            ...
            self.toutput = layers.generative0(tlatent1_state, self.iladder0_sample, self.class_label_placeholder, self.n_classes, is_training=self.is_training)
            self.goutput = layers.generative0(glatent1_state, self.ladder0_placeholder, self.class_label_placeholder, self.n_classes, reuse=True, is_training=False)
        elif tlatent1_state is not None:
            self.toutput = layers.generative0(tlatent1_state, None, self.class_label_placeholder, self.n_classes, is_training=self.is_training)
            self.goutput = layers.generative0(glatent1_state, None, self.class_label_placeholder, self.n_classes, reuse=True, is_training=False)
        else:
